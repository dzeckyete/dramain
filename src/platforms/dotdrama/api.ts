...
export class DotDramaAPI extends BaseAPI {
  ...
  async getCollections() {
    return this.request(PLATFORM_CONFIG.api.collections);
  }
  ...
  async getLanguages() {
    return this.request(PLATFORM_CONFIG.api.languages);
  }
}
